...
namespace OnlyNew.BodyProportions
{
    ...
    public struct ScalableBoneUpdateJob : IJobParallelForTransform
    {
        [ReadOnly]
        ...
        public void Execute(int index, TransformAccess transform)
        {
            if (!enable[index])
                return;
            bool _enableRefreshRelativeRotation;
            bool _enableFollowParent;
            //read transform
            {
            ...
            //calculate flag
            {
                ...
                _enableRefreshRelativeRotation = false;
                _enableFollowParent = false;
